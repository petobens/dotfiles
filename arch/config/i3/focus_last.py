#!/usr/bin/env python3
"""Focus last window."""
# From: https://github.com/altdesktop/i3ipc-python/blob/master/examples/focus-last.py
...
class FocusWatcher:
    ...
    def on_window_focus(self, i3conn, event):  # pylint:disable=unused-argument
...
if __name__ == '__main__':
    parser = ArgumentParser(
        ...
        This script should be launch from the i3 config without argument.
