...
% Use small caps for names and surnames of authors
% In beamer use upper case since Latin Modern Sans doesn't have small caps and
...
\renewcommand*{\mkbibnamelast}[1]{\ifmknamesc{%
...
\renewcommand*{\finalnamedelim}{\ifmknamesc{\addspace\iftoggle{textcite}{%
  \bibstring{and}}{\changefont{\bibstring{and}}}\space}{%
