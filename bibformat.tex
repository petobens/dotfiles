...
% FIXME: This doesn't quite work (if hyperref is not included it will throw
% errors probably because the code to color hyperlinks appears before loading)
% Also see tex question: apptocmd into a conditional
\AtEndPreamble{\@ifpackageloaded{hyperref}{}{\usepackage{hyperref}}}
% \@ifpackageloaded{hyperref}{}{\AtEndPreamble{\usepackage{hyperref}}}
\makeatother
