...
%-----------------------------------+
% Beamer/fullcite specific settings |
%-----------------------------------+
...
% Use upper case since Latin Modern Sans doesn't have small caps for authors
% names and also do this text (since we use fullcite)
\makeatletter
...
\renewcommand*{\mkbibnamefirst}[1]{\ifmknamesc{\MakeUppercase{#1}}{#1}}
\renewcommand*{\mkbibnamelast}[1]{\ifmknamesc{\MakeUppercase{#1}}{#1}}
\renewcommand*{\mkbibnameprefix}[1]{%
  \ifmknamesc{\MakeUppercase{\MakeCapital{#1}}}{\MakeCapital{#1}}}
\renewcommand*{\mkbibnameaffix}[1]{\ifmknamesc{\MakeUppercase{#1}}{#1}}
\renewcommand*{\finalnamedelim}{\ifmknamesc{%
\addspace{\bibstring{and}}\space}{\addspace\bibstring{and}\space}}
}%
}{}%
\makeatother
