    ...
    background:ask({
        {
            ...
            content = table.concat({
                ...
                'uses its most useful retrieval terms.',
                'Capture the durable implementation, diagnosis, or decision.',
                'Keep a short user request unchanged when it already makes a',
                'good title.',
                'Include two clearly distinct substantial topics when both fit.',
                'Do not let a tiny final tweak replace the main topic.',
