...
-- TODO:
-- Fetch enter url has no spaces
-- https://github.com/olimorris/codecompanion.nvim/pull/953
-- Feature to pass a path to file slash commands
-- https://github.com/olimorris/codecompanion.nvim/discussions/947
-- Render markdown icons for <file>, <buffer> and <url> fetch command
-- https://github.com/MeanderingProgrammer/render-markdown.nvim/issues/336
