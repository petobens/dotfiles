...
onedarkpro.setup({
    ...
    hlgroups = {
        ...
        SpellBad = { fg = p.fg, sp = p.red, style = 'undercurl' },
        SpellCap = { fg = p.fg, sp = p.orange, style = 'undercurl' },
        SpellLocal = { fg = p.fg, sp = p.orange, style = 'undercurl' },
        SpellRare = { fg = p.fg, sp = p.orange, style = 'undercurl' },
