...
vim.keymap.set('n', '<A-u>', 'mzg~iw`z') -- Toggle case of word under cursor
vim.keymap.set({ 'n', 'v' }, '+', '<C-a>')
vim.keymap.set({ 'n', 'v' }, '-', '<C-x>')

-- Yank and paste
vim.keymap.set('n', 'Y', 'y$')
vim.keymap.set('n', 'yy', 'mz0y$`z')
...
vim.keymap.set('n', 'vv', '^vg_') -- visually select excluding indentation
vim.keymap.set('v', '<', '<gv')
vim.keymap.set('v', '>', '>gv')
...
vim.keymap.set('t', '<C-A-n>', ('%s:bn<CR>'):format(terminal_escape))
vim.keymap.set('t', '<C-A-p>', ('%s:bp<CR>'):format(terminal_escape))
vim.keymap.set('t', '<C-h>', ('%s<C-W>h'):format(terminal_escape))
vim.keymap.set('t', '<C-j>', ('%s<C-W>j'):format(terminal_escape))
vim.keymap.set('t', '<C-k>', ('%s<C-W>k'):format(terminal_escape))
vim.keymap.set('t', '<C-l>', ('%s<C-W>l'):format(terminal_escape))
