...
symlink "$repo/config/quickshell" "$HOME/.config/quickshell"
...
symlink "$repo/config/themes" "$HOME/.config/themes"
...
symlink "$repo/config/wireplumber" "$HOME/.config/wireplumber"
